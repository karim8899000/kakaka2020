...
admin_chat_id = ida
user_data = {}
TOKEN = "7078228710:AAGdQ8rO_citRP-gJL_C0ciFPRoZZ8KdBn8"
token = TOKEN
admin = ida
...
linkpas="https://ouo.io/8Jlylj"
we10="https://t.me/Legends_Team_2024/1800"
face="https://t.me/Legends_Team_2024/1828"
yout="https://t.me/Legends_Team_2024/1829"
...
def send_admin_commands(message):
    ...
    if is_admin(chat_id):
        ...
        keyboard.add(
            ...
            types.InlineKeyboardButton('تغيير اللنك ', callback_data='chg_link'),
...
def start(message):
 if check_subscription(message.chat.id):
    ...
    keyboard.add(
     ...
     types.InlineKeyboardButton('قسم خدمات اورنج', callback_data='open_menu'),
...
def callback_query(call):
    ...
    if call.data == 'open_menu':
        ...
        menu_keyboard = types.InlineKeyboardMarkup()
        menu_keyboard.row(
            types.InlineKeyboardButton("المطور", url="https://t.me/S_6_k"),
            types.InlineKeyboardButton("المطور", url="https://t.me/A_G_9"),
     ...
     bot.send_message(call.message.chat.id, "قسم الكونفجات", reply_markup=menu_keyboard)
        ...
        bot.send_message(call.message.chat.id, "برجاء إرسال رقم الهاتف الخاص بك:")
        bot.register_next_step_handler(call.message, houre)

    elif call.data == "DF":
     msg = bot.send_message(call.message.chat.id, "من فضلك أدخل رقم هاتفك:")
     ...
     bot.send_message(call.message.chat.id, "قسم الفلكسات", reply_markup=menu_keyboard)
        ...
        bot.send_message(call.message.chat.id, "   برجاء إرسال لنك الفديو")
        bot.register_next_step_handler(call.message, dontik)
    elif call.data == "ins":
        bot.send_message(call.message.chat.id, "   برجاء إرسال اللنك ")
        ...
        bot.send_message(call.message.chat.id, "من فضلك ارسل اللنك علي هيئة \n https://vm.tiktok.com/ZMMcsC6C7/")
...
def rash3(message,link):
    ...
    try:
        ...
        if response_data.get('message') == 'Success! You will receive views on your tiktok video within next few minutes.' and response_data.get('status'):
            ...
            bot.reply_to(message, "  اللنك مش ع الشكل المطلوب  ")
